...
export class PreviewScoringService {
	...
	getScorecardsQuestions(scorecard) {
	...
	getScorecardsQuestionNotes(scorecardRelationship) {
	...
	getScorecardAreaScorings(scorecardWeightedScore) {
